...
This repository is a publication-oriented snapshot of the historical
`conversation_to_github_projects` application developed inside the lab.

The public snapshot keeps the reusable application source and removes the
